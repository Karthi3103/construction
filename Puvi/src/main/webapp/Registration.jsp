...
<body class="bg-dark">
    ...
    <div class="container dis_back2 mb-4 bg-white">
     ...
     <form action="Insert" method="post">
      ...
      <!-- house no details -->
        <div class="form-outline mb-4">
            <input type="text" id="form2Example1" class="form-control" name="Employee_House_No" required/>
            <label class="form-label " for="form2Example1" >House no</label>
          </div>
        
          <!--Street -->
        <div class="form-outline mb-4">
            <input type="text" id="form2Example1" class="form-control" name="Employee_Street" required />
          ...
          <!--City -->
        <div class="form-outline mb-4">
            <input type="text" id="form2Example1" class="form-control" name="Employee_City" required/>
            <label class="form-label " for="form2Example1" >City</label>
          </div>
          
             <!--District -->
        <div class="form-outline mb-4">
            <input type="text" id="form2Example1" class="form-control" name="Employee_District" required/>
            <label class="form-label " for="form2Example1 " >District</label>
          </div>
          
              <!--State -->
        <div class="form-outline mb-4">
            <input type="text" id="form2Example1" class="form-control" name="Employee_State" required/>
            <label class="form-label " for="form2Example1" >State</label>
          </div>
          
               <!--Pincode -->
        <div class="form-outline mb-4">
            <input type="text" id="form2Example1" class="form-control" name="Employee_Pincode"  required/>
