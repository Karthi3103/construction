...
String sql="Update customer set customer_name=?, customer_email_id=?, customer_phone=?, customer_address=?, site_location=? ,site_area=? ,site_district=?,site_state=?,site_pincode=?,site_details=?, emp_id=? where customer_id=?";
