...
<body class="bg-black">
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide " data-bs-ride="carousel">
        ...
        <div class="row">
          ...
          <div class="col-sm-4 box2">
            ...
            <ul class="list-group">
              ...
              <li class="list-group text-white">Cost Management</li>
              <li class="list-group text-white">Resource Monitoring</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid about_div" id="aboutus">
        ...
        <p id="about_text" class="text-white">Puviyagam is a unique architecture, engineering, and 
