    ...
    <div class="container dis_back2 mb-4 bg-white">
     ...
     <form action="Insert" method="post">
        ...
        <div class="form-outline mb-4">
          ...
          <input type="text" id="form2Example1" class="form-control" name="Employee_Name" value="${Employee_Name}"required/>
        </div>
      
        <!-- Email-id input -->
        <div class="form-outline mb-4">
          <label class="form-label" for="form2Example2" >Email Id</label>
          <input type="email" id="form2Example2" class="form-control"  name="Employee_Email" value="${Employee_Email}" required/>
        </div>
        ...
        <div class="form-outline mb-4">
            ...
            <input type="number" class="form-control" id="form2Example1" name="Employee_Mobile_No" value="${Employee_Mobile_No}" required>
        </div>
      ...
      <!-- Address details -->
        <div class="form-outline mb-4">
            ...
            <textarea  id="form2Example1" class="form-control" name="Employee_Address" >${Employee_Address }</textarea>
