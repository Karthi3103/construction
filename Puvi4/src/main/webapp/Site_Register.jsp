 ...
 <!--navbar start-->
    ...
    <div class="container dis_back2 mb-4 bg-white">
     ...
     <div class="form-outline mb-4">
        ...
        <div class="form-outline mb-4">
        <label class="form-label " for="form2Example1" >Site Estimation Amount</label>
            <input type="number" id="form2Example1" class="form-control" name="Site_Estimation_Amount"  required/>
